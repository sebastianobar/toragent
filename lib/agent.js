 ...
 *
 * @param   {string}  [torPath] optional path of Tor binary
 ...
 */
TorAgent.create = function(torPath = 'tor', verbose, fn) {
  var port;
  ...
  return openports(1).then(function(ports) {
    ...
    return Tor.spawn(port, res[0], 30000, torPath);
  }).then(function(tor) {
    if (verbose) {
...
TorAgent.prototype.createConnection = function(opts) {
  ...
  var protocol = opts.protocol || opts.uri.protocol;
  if (protocol === 'https:') {
